  ...
  return (
    <div className="flex items-center justify-between p-3 hover:bg-white/5 rounded-lg transition-colors group relative">
      <div className="flex items-center gap-4">
         ...
         >
            <span className={`text-muted-foreground text-sm font-medium ${!showImage ? "group-hover:hidden" : ""}`}>{index + 1}</span>
            {!showImage && (
      ...
      <span className="text-sm text-muted-foreground font-medium hidden lg:block absolute left-1/2 -translate-x-1/2">{music.duration}</span>
      ...
      <div className="flex items-center gap-1 sm:gap-3">
          ...
          <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-foreground hover:bg-transparent cursor-pointer">
              ...
              <DropdownMenuContent align="end">
                  ...
                  {isInsideOwnedPlaylist && (
                      <DropdownMenuItem onClick={handleRemoveFromPlaylist} className="cursor-pointer text-destructive focus:text-destructive">
