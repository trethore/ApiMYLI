            ...
            <section>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ContentGrid
                    items={mockArtist.albums.map((album) => ({
                      name: album.name,
                      type: album.type,
                ...
                <div>
                  ...
                  <ContentGrid
                    items={mockArtist.singles.map((single) => ({
                      name: single.name,
                      type: single.type,
              ...
              <div className="relative h-64 w-full rounded-lg overflow-hidden mb-4 bg-muted">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-4">
                  <p className="text-white font-bold line-clamp-3">
                    {mockArtist.name} est un artiste de renommée mondiale connu pour son style
                    unique mélangeant pop, rock et électro...
                  </p>
                </div>
              </div>
