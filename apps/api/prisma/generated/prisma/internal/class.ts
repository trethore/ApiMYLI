...
/**
  ...
  /**
   * `prisma.userPinnedItem`: Exposes CRUD operations for the **UserPinnedItem** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more UserPinnedItems
    * const userPinnedItems = await prisma.userPinnedItem.findMany()
    * ```
    */
  get userPinnedItem(): Prisma.UserPinnedItemDelegate<ExtArgs, { omit: OmitOpts }>;
