...
\copy stg_track FROM './data/clean_tracks.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',');
...
\copy stg_raw_track_numbers FROM './data/clean_raw_tracks.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',');
