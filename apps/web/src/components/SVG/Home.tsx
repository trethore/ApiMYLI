export default function Home({ color = "currentColor" }: { color?: string }) {
  return (
    <>
    <svg className="w-full h-full" viewBox="-2 0 21 21" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill={color}>
