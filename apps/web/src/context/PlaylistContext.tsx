...
const initialPlaylists: Album[] = [
  {
    ...
    type: "Playlist",
    tracks: [
        { id: "p1-t1", title: "Track 1", artist: ["Artist A"], album: "Album A", duration: "3:00", isLiked: true },
        { id: "p1-t2", title: "Track 2", artist: ["Artist B"], album: "Album B", duration: "3:30", isLiked: false },
    ]
  }
]
...
export const PlaylistProvider = ({ children }: { children: ReactNode }) => {
  ...
  const updatePlaylist = (id: string, name: string, imageUrl?: string) => {
    setPlaylists(playlists.map(p => 
      p.id === id ? { ...p, name, image: imageUrl || p.image } : p
    ))
  }
