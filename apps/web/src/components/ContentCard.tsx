...
export default function ContentCard({ imageUrl, name, link, type, priority = false }: ContentCardProps) {
  return (
    <Link href={link} className="block w-full group hover:cursor-pointer transition-all duration-300 hover:scale-[1.02] bg-gradient-to-br from-[var(--color-muse-sky-blue)] to-[var(--color-muse-pink)] rounded-lg">
